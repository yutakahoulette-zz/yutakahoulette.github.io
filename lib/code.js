...
, { title: 'Should I?'
  , desc: [a('Should I?', 'http://yutakahoulette.com/should_i') , ' is a single-page app for helping people quantify and visualize the pros and cons of their conundrums.'] 
...
, { title: 'Text to Marbles'
  , desc: [a('Text to Marbles', 'http://yutakahoulette.com/text-to-marbles/demo/'), " is an NPM module which takes a string and converts it to a HTML canvas drawing of stream ‘marbles’. It is intended to augment documentation for stream-based libraries like Rx and Flyd."]
...
const article = (project, i) => {
  ...
  const txt = h('figcaption.smooth.col-5.color-black'
    , {class: {
